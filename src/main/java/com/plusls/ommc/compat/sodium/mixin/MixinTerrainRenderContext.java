...
public class MixinTerrainRenderContext {
    ...
    @Redirect(method = "renderBlock", at = @At(value = "INVOKE",
            ...
            ordinal = 0,
            remap = true))
    private void emitCustomBlockQuads(FabricBakedModel model, BlockAndTintGetter blockView, BlockState state, BlockPos pos, @Coerce Object randomSupplier, RenderContext context) {
